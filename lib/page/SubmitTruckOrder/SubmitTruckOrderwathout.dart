...
class SubmitTruckOrderOut extends StatefulWidget {
  int id;

  SubmitTruckOrderOut(this.id);

  @override
  _SubmitTruckOrderOutState createState() => _SubmitTruckOrderOutState();
}

class _SubmitTruckOrderOutState extends State<SubmitTruckOrderOut> {
  Marker? _marker;
  bool type = true;
                          ...
                          showDialog(
                              ...
                              builder: (context) {
                                return OrderonfirmationMssagePage(
                                  ...
                                  start_address: titel1,
                                  start_latitude: double.parse(
                                      data["start_latitude"].toString()),
                                  start_longitude: double.parse(
                                      data["start_longitude"].toString()),
                                  end_address: titel2,
                                  end_latitude: double.parse(
                                      data["end_latitude"].toString()),
                                  end_longitude: double.parse(
                                      data["end_longitude"].toString()),
